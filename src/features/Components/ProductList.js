      ...
      <div className="bg-white">
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-0 pt-20">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 pb-6">
                Products
              </h1>
              ...
              <div className="flex items-center">
                <Menu as="div" className="relative inline-block text-left">
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-16 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="py-1">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-0">
              <div className="grid grid-cols-1 gap-x-8 gap-y-1 lg:grid-cols-4">
                {/* Filters */}
